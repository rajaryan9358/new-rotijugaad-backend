...
const Setting = sequelize.define('Setting', {
  ...
  employer_ad_credit: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },

  employee_welcome_subscription_days: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  employer_welcome_subscription_days: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },

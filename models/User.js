...
const User = sequelize.define('User', {
  ...
  // Mobile change OTP flow (used by /employees/:id/aadhar/* and /employers/:id/aadhar/*)
  mobile_change_pending: {
    type: DataTypes.STRING,
    allowNull: true,
  },
  mobile_change_otp_session_id: {
    type: DataTypes.STRING,
    allowNull: true,
  },
  mobile_change_otp_created_at: {
    type: DataTypes.DATE,
    allowNull: true,
  },
  referred_by: {

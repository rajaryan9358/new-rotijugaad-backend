...
const EmployerShortlistedCandidate = require('./EmployerShortlistedCandidate');
const JobDay = require('./JobDay');
const JobInterest = require('./JobInterest');
const InterviewerContactOtp = require('./InterviewerContactOtp'); // <-- Add this line
...
Employer.hasMany(EmployerShortlistedCandidate, { foreignKey: 'employer_id', as: 'ShortlistedCandidates' });

Employee.hasMany(EmployerShortlistedCandidate, { foreignKey: 'employee_id', as: 'EmployerShortlists' });
EmployerShortlistedCandidate.belongsTo(Employer, { foreignKey: 'employer_id', as: 'Employer' });
EmployerShortlistedCandidate.belongsTo(Employee, { foreignKey: 'employee_id', as: 'Employee' });
...
Job.belongsTo(SalaryType, { foreignKey: 'salary_type_id', as: 'SalaryType' });

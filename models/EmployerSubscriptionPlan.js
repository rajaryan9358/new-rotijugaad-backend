...
const EmployerSubscriptionPlan = sequelize.define('EmployerSubscriptionPlan', {
  ...
  discounted_price: { type: DataTypes.DECIMAL(12,2), allowNull: true, defaultValue: null },
  ...
  ad_credits: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  ...
  tableName: 'employer_subscription_plans',
  timestamps: true,
  paranoid: true,
...
module.exports = EmployerSubscriptionPlan;
